...
const FADEOUT_DELAY_MS = ICONS.length * STAGGER_MS + HOLD_AFTER_MS; // 1900ms
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', opacity: visible[0] ? 1 : 0, transition: 'opacity .4s' }}>
          <h1 style={{
            ...
            color: '#1a1c20', letterSpacing: '-.02em', margin: 0,
          }}>
        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
          {ICONS.map((icon, i) => (
            <div key={i} style={{
              ...
              opacity: 0,
              animation: visible[i] ? 'iconIn .4s cubic-bezier(.22,1,.36,1) forwards' : 'none',
            }}>
              <div style={{
                width: 52, height: 52,
        ...
        <div style={{
          ...
          <div style={{
            ...
            animation: `barFill 2.2s .2s cubic-bezier(.4,0,.2,1) both`,
          }} />
        </div>
